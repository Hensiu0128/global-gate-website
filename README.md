...
| `npm test` | Runs the automated test suite once (currently 212 tests covering components, page content, and site-wide rules such as "the copyright year is always correct" and "the site never claims 24/7 support"). Run this after any change. |
